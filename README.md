[![Build Status](https://dev.azure.com/tsarangel/AzureRMPipeline/_apis/build/status/TsarSPb.python-sample-vscode-flask-tutorial?branchName=master)](https://dev.azure.com/tsarangel/AzureRMPipeline/_build/latest?definitionId=5&branchName=master)
